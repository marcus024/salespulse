...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#36b9cc;">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="it_team.php">
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-info btn-icon-split w-70 " onclick=addOutlookCalendar()>
                                    ...
                                    <span class="text" style="font-family:'Poppins'">Add Calendar</span>
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        function addCalendar(type) {
            ...
            newCalendar.className = 'calendar-item';
            newCalendar.style.border = '1px solid white';
            newCalendar.style.marginBottom = '10px';
            newCalendar.style.padding = '10px';
            newCalendar.style.borderRadius = '5px';
            newCalendar.innerHTML = `
                <h5>${type} Calendar</h5>
                <p>This is a ${type.toLowerCase()} calendar entry.</p>
            `;
