    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:#36b9cc; width: 250px;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SALES PULSE-IT</div>
            </a>
                                ...
                                <div class="card-body" id="calendar-container" style="min-height: 400px; color: white;">
                                    ...
                                    <div id="contact-list" class="contact-list">
                                        ...
                                        <div class="card mb-3" style="border-radius: 20px;">
                                            ...
                                            <div class="card-body" style="background-color: white; color: #555; padding: 10px; border-radius:20px; padding-left: 20px;">
                                                <div class="d-flex align-items-center mb-2" style="gap: 30px;">
                                                    <img src="../images/woman.png" alt="Contact 1" class="contact-image" style="width: 130px; height: 130px; border-radius: 50%;">
                                                    <div class="contact-info">
                                                        ...
                                                        <div class="row mt-0" style="gap: 10px; padding-right:5px;">
                                                            <div class="col card text-center" style="border-color:white; background: white; border-radius: 15px; padding: 2px; width: 140px;">
                                                                <p style="font-size: 30px; color:#006270; font-weight: bold; margin: 0; text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3);">25</p>
                                                                <p style="font-size: 9px; font-weight: bold; color: #006270; margin: 0; width: 100%;">Completed Projects</p>
                                                            </div>
                                                            <div class="col card text-center" style="border-color:white; background: white; border-radius: 15px; padding: 2px; width: 140px;">
                                                                <p style="font-size: 30px; color:#006270; font-weight: bold; margin: 0; text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3);">5</p>
                                                            ...
                                                            <div class="col card text-center" style="border-color:white; background: white; border-radius: 15px; padding: 2px; width: 100px;">
                                                                <p style="font-size: 30px; color:#006270; font-weight: bold; margin: 0; text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3);">2</p>
                                                                <p style="font-size: 9px; font-weight: bold; color:#006270; margin: 0; width: 100%;">Cancelled Projects</p>
                                                            </div>
                                                            <div class="col card text-center" style="border-color:white; background: white; border-radius: 15px; padding: 2px; width: 140px;">
                                                                <p style="font-size: 30px; color:#006270; font-weight: bold; margin: 0; text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.3);">10</p>
                                        ...
                                        <div class="card mb-3" style="border-radius: 20px;">
                                            ...
                                            <div class="card-body" style="background-color: white; color: #555; padding: 10px; border-radius:20px; padding-left: 20px;">
                                                <div class="d-flex align-items-center mb-2" style="gap: 30px;">
                                                    <img src="../images/man.png" alt="Contact 1" class="contact-image" style="width: 130px; height: 130px; border-radius: 50%;">
                                                    <div class="contact-info">
                                                        <p class="mb-1" style="font-size: 30px; font-weight: bold; font-family: 'Poppins';">
                                                            Juan Dela Cruz
                                                        </p>
