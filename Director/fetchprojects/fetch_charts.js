...
$('#calendar-container').before(`
    <div style=" width: 750px; padding-left:20px; padding-top: 10px;padding-bottom: 0px; padding-right: 25px; display: flex; justify-content: space-between; align-items: center;">
        <!-- Title on the Left -->
        <div>
