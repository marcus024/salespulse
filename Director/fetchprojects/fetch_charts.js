...
$('#calendar-container').before(`
    <div class="mb-1" style="margin: 10px; width: 250px;  top: 10px; right: 10px; display: flex; align-items: center; justify-content: space-between;">
        ...
        <button id="refreshButton" class="btn btn-secondary" style="margin-left: 1px; margin-top:20px; font-family;'Poppins'; font-size:12px; height:30px; width:70px;">Refresh</button>
