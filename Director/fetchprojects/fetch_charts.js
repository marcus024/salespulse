...
$('#calendar-container').before(`
    <div style="margin: 10px; width: 700px; top: 10px; right: 10px; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <button id="refreshButton" class="btn btn-secondary" style="margin-left: 5px; margin-top:20px; font-family: 'Poppins'; font-size: 12px; height: 30px; width: 70px;">Refresh</button>
            <div class="btn-group" role="group" style="margin-left: 5px;margin-top:20px;">
                <!-- Export Dropdown -->
