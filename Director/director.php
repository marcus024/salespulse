                            ...
                            <div class="card-body" style="margin-top: 0.25rem; margin-bottom: 0.5rem; ">
                                ...
                                <div class="col-md-14 mb-3">
                                    <div class="card shadow mb-4" style="box-shadow: 2px 4px 8px rgba(0, 0, 0, 0.2); margin-bottom: 0.2rem; background-color:#1f2024; border:none;">
                                        <div class="card-header py-3 d-flex justify-content-between align-items-center" style="background-color: #1f2024;  height: auto; border:none;">
                                            <!-- Title -->
                                ...
                                <div class="col-md-14 mb-1 ">
                                    <div class="row mt-0 " style=" margin-top: 0.25rem">
                                        <div class="card col-md-5 shadow mb-1 mx-3 p-0" style="border:none; background-color: #2a2925; box-shadow: 2px 4px 8px rgba(0, 0, 0, 0.2);">
                                            <div class="card-header py-1" style="background: #2a2925; border-bottom: 1px solid darkgrey;">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <!-- Left-aligned text -->
                                                ...
                                                <!-- Schedule Widget -->
                                                 <div class="d-flex flex-column gap-3">
                                                    ...
                                                    $query = "
                                                        ...
                                                        if (empty($schedules)) {
                                                            echo '<div class="p-2 " style="font-size: 10px; background-color: #2a2925; color: white; border:none;">
