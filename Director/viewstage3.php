                                    ...
                                    <div class="container" style="background-color: #36b9cc; padding: 10px; border-radius: 20px">
                                        <div class="modal-body">
                                                ...
                                                <div class="container mt-4 p-3" style="background: white; border-radius: 8px;">
                                                    <h3 style="font-family: 'Poppins', sans-serif; font-weight: bold; color: #555; text-align: center; margin-bottom: 5pxpx;">Stage 3 of <?php echo htmlspecialchars($project['company_name']); ?></h3>
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="container" style="background-color:white; padding: 5px; border-radius: 20px">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                type="text"
                                                                class="form-control"
                                                                id="stage-three-start"
                                                                readonly
                                                                value="<?php echo htmlspecialchars($stageThreeRow['start_date_stage_three'] ?? ''); ?>"
                                                                >
                                                            </div>
                                                            <!-- End Date -->
                                                            <div class="col-md-3">
                                                                ...
                                                                id="stage-three-end"
                                                                readonly
                                                                value="<?php echo htmlspecialchars($stageThreeRow['end_date_stage_three'] ?? ''); ?>"
                                                                >
                                                            </div>
                                                            <!-- Status -->
                                                            <div class="col-md-3">
                                                                ...
                                                                type="text"
                                                                class="form-control"
                                                                id="stage-three-status"
                                                                readonly
                                                                value="<?php echo htmlspecialchars($stageThreeRow['status_stage_three'] ?? ''); ?>"
                                                                >
                                                            </div>
                                                            <!-- Technology -->
                                                            <div class="col-md-3">
                                                                ...
                                                                id="technology3"
                                                                readonly
                                                                value="<?php echo htmlspecialchars($stageThreeRow['technology'] ?? ''); ?>"
                                                                >
                                                            </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                id="product3"
                                                                readonly
                                                                value="<?php echo htmlspecialchars($stageThreeRow['product'] ?? ''); ?>"
                                                                >
                                                            </div>
                                                            <!-- Deal Size -->
                                                            <div class="col-md-3">
                                                                ...
                                                                id="dealSize3"
                                                                readonly
                                                                value="<?php echo htmlspecialchars($stageThreeRow['deal_size'] ?? ''); ?>"
                                                                >
                                                            </div>
                                                            <!-- Solution -->
                                                            <div class="col-md-6">
                                                                ...
                                                                style="font-size:12px; color:#555"
                                                                readonly
                                                                ><?php echo htmlspecialchars($stageThreeRow['solution'] ?? ''); ?></textarea>
                                                            </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <?php if (!empty($engagements)): ?>
                                                                ...
                                                                <div class="row engagement-fields mb-3">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        class="form-control"
                                                                        readonly
                                                                        value="<?php echo htmlspecialchars($eng['engagement_three'] ?? ''); ?>"
                                                                    >
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                    <input
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        class="form-control"
                                                                        readonly
                                                                        value="<?php echo htmlspecialchars($eng['engagement_remarks_three'] ?? ''); ?>"
                                                                    >
                                                                    </div>
                                                                </div>
                                                                <?php endforeach; ?>
                                                        ...
                                                        <div class="container" style="background-color:white; padding: 5px; border-radius: 20px">
                                                            ...
                                                            <div class="col-md-2">
                                                                <label style="font-size:12px; color:#555" class="form-label">Bill of Materials</label>
                                                            </div>
                                                            <div class="col-md-2">
                                                            ...
                                                            <?php if (!empty($requirements)): ?>
                                                                ...
                                                                <div class="row requirement-fields mb-3">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        class="form-control"
                                                                        readonly
                                                                        value="<?php echo htmlspecialchars($req['requirement_three'] ?? ''); ?>"
                                                                    >
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                    <input
                                                                        ...
                                                                        class="form-control"
                                                                        readonly
                                                                        value="<?php echo htmlspecialchars($req['quantity'] ?? ''); ?>"
                                                                    >
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                    <input
                                                                        ...
                                                                        class="form-control"
                                                                        readonly
                                                                        value="<?php echo htmlspecialchars($req['bill_of_materials'] ?? ''); ?>"
                                                                    >
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                    <input
                                                                        ...
                                                                        class="form-control"
                                                                        readonly
                                                                        value="<?php echo htmlspecialchars($req['pricing'] ?? ''); ?>"
                                                                    >
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                    <input
                                                                        ...
                                                                        class="form-control"
                                                                        readonly
                                                                        value="<?php echo htmlspecialchars($req['requirement_remarks_three'] ?? ''); ?>"
                                                                    >
                                                                    </div>
                                                                </div>
                                                                <?php endforeach; ?>
                                                        ...
                                                        <div class="container" style="background-color:white; padding: 10px; border-radius: 20px">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                type="text"
                                                                class="form-control"
                                                                id="stage-three-remarks"
                                                                readonly
                                                                value="<?php echo htmlspecialchars($stageThreeRow['stage_three_remarks'] ?? ''); ?>"
                                                                >
                                                            </div>
                                                            </div>
                                                        </div>
