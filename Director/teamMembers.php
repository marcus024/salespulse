                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <ul class="list-group" id="userList" class="userClass" style="max-height: 380px; overflow-y: auto;">
                                            <!-- Example user items -->
                                            <li class="list-group-item d-flex justify-content-between align-items-center" style="font-family:'Poppins'; font-size: 14px;">
                                                <div>
                                                    <strong>John Doe</strong>
                                                    <p class="mb-0 text-muted" style="font-size: 12px;">Software Engineer</p>
                                                </div>
                                                <button class="btn btn-sm btn-primary" style="background-color: #36b9cc; border: none;" onclick="addUser('John Doe')">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-center" style="font-family:'Poppins'; font-size: 14px;">
                                                <div>
                                                    ...
                                                    <p class="mb-0 text-muted" style="font-size: 12px;">Project Manager</p>
                                                </div>
                                                <button class="btn btn-sm btn-primary" style="background-color: #36b9cc; border: none;" onclick="addUser('Jane Smith')">
                                                    <i class="fas fa-plus"></i> Add
                                                </button>
                                            </li>
                                        </ul>
